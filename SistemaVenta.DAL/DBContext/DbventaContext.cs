...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C701A710C");
        ...
        {
            entity.HasKey(e => e.IdDetalle).HasName("PK__DetalleV__49CAE2FB55A7AF71");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF48382D01901");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A44ADFFBE0");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A55D094F4");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1328816698F");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76153AADDD");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6FB1255DA");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614528424D5");
